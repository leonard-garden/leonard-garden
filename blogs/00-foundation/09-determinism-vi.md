...
Nếu eval của bạn không account for variance, một score drop từ 87% → 84% có thể chỉ là sampling noise, không phải regression thật. Chạy eval nhiều lần rồi lấy trung bình, hoặc dùng statistical significance test trước khi kết luận có regression.
