---
title: "Context Window: The Working Memory Limit of LLMs"
description: "A context window is the total number of tokens a model processes in one call — input and output combined. Claude currently supports 200K tokens. When the context fills up, older information is lost — this is a physical constraint, not a bug."
locale: "en"
