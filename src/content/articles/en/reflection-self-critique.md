---
title: "Reflection / Self-critique: LLMs Evaluating Their Own Output"
description: "Reflection is a prompting technique that asks a model to evaluate its own output against specific criteria, then rewrite based on that critique. Instead of accepting the first answer, you add a critique step where the model shifts from author to reviewer. This works especially well for code generation, writing, and tasks with clear quality criteria."
locale: "en"
