---
title: "Context Window: Giới Hạn Bộ Nhớ Làm Việc của LLM"
description: "Context window là tổng số token mà model xử lý trong một lần — input cộng output cộng lại. Claude hiện hỗ trợ 200K token. Khi context đầy, thông tin cũ sẽ mất — đây là ràng buộc vật lý, không phải bug."
locale: "vi"
