---
title: "Embedding: Cách LLM hiểu nghĩa của ngôn ngữ"
description: "Embedding là quá trình chuyển đổi văn bản thành vector số học dày đặc sao cho các đoạn văn có nghĩa tương tự nhau sẽ có vector gần nhau trong không gian nhiều chiều. Đây là nền tảng kỹ thuật của RAG, semantic search, và clustering. Nếu bạn đang build ứng dụng AI xử lý ngôn ngữ tự nhiên, khả năng cao bạn sẽ cần embedding."
locale: "vi"
