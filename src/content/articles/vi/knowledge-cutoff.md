---
title: "Knowledge Cutoff: Giới hạn thời gian của LLM và cách làm việc với nó"
description: "Knowledge cutoff là ngày mà training data của một LLM kết thúc — model không có kiến thức về bất kỳ sự kiện nào xảy ra sau ngày đó. Đây không phải bug mà là đặc tính tất yếu của cách LLM được train. Biết cách xử lý knowledge cutoff là điều kiện bắt buộc để tránh những lỗi sai nhục nhã trong production."
locale: "vi"
