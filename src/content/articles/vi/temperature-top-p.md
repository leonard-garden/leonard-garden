---
title: "Temperature & Top-p — Bạn điều khiển độ ngẫu nhiên của LLM như thế nào"
description: "Temperature và Top-p là hai tham số điều khiển cách LLM chọn token tiếp theo khi sinh text. Temperature scale toàn bộ phân phối xác suất, Top-p giới hạn pool sampling chỉ còn các token có cumulative probability cao nhất. Hiểu đúng hai tham số này giúp bạn kiểm soát output từ \"sáng tạo, đa dạng\" sang \"nhất quán, chính xác\" một cách có chủ ý."
locale: "vi"
translationKey: "temperature-top-p"
