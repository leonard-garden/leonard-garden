...
description: "System prompt là lệnh mà developer đặt vào trước khi người dùng nói bất cứ điều gì — nó định hình nhân cách, giới hạn và nhiệm vụ của model. User prompt là điều người dùng thực sự gõ vào trong mỗi turn. Hai thứ này chiếm hai vị trí riêng biệt trong context window và model đọc chúng theo trật tự cố định."
locale: "vi"
