...
description: "Hallucination là hiện tượng LLM sinh ra thông tin trông có vẻ đúng nhưng thực ra sai hoặc không tồn tại. Grounding là kỹ thuật buộc model phải trả lời dựa trên nguồn dữ liệu cụ thể thay vì dựa vào \"trí nhớ\" của nó. Hiểu rõ hai khái niệm này giúp bạn biết khi nào nên tin LLM và khi nào phải kiểm tra lại."
locale: "vi"
